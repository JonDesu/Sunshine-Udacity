...
public class ArticleListActivity extends AppCompatActivity implements
    ...
    public void onRefresh() {
        if (NetworkAvailable(this)) startService(new Intent(this, UpdaterService.class));
        else {
            Toast.makeText(this, "Please connect to internet to refresh.", Toast.LENGTH_SHORT).show();
